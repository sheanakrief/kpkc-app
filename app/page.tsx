...
const MODULES = [
  ...
  },
  {
    ...
    nom: "AUTO",
    nomComplet: "PARKAUTO",
    sousTitre: "Mes véhicules",
    description:
      "Flotte personnelle & professionnelle, assurances auto, contrôles techniques, entretien, échéances.",
    Icon: Car,
    color: "#2C3E50",
  ...
  },
  {
    ...
    description:
      "Assurances, sinistres, litiges, conformité juridique. Module transversal avec spécificité par domaine (immo, pro, perso, auto).",
    Icon: Shield,
    color: "#C0392B",
